                ...
                <div className='m-5 bg-bg-light p-3 space-y-5'>
                    ...
                    <div className='flex flex-col gap-3 md:flex-row'>
                        <Controller
                            ...
                            control={control}
                            render={({ field }) => (
                                <DropDownComponent label="Branch City" name="city" options={dayOptions} value={field.value} onChange={field.onChange} />
                            )}
                        />
                        <Controller
                            name="country"
                            control={control}
                            render={({ field }) => (
                                <DropDownComponent label="Branch Country" name="country" options={dayOptions} value={field.value} onChange={field.onChange} />
                            )}
                        />
                    </div>
                    <div className='flex flex-col gap-3 md:flex-row'>
                        <Controller
                            ...
                            control={control}
                            render={({ field }) => (
                                <DropDownComponent label="Choose Day" name="day" options={dayOptions} value={field.value} onChange={field.onChange} />
                            )}
                        />
                        ...
                        <Controller
                            ...
                            control={control}
                            render={({ field }) => (
                                <DropDownComponent label="Opening Hours" name="opening-hours" options={timeOptions} value={field.value} onChange={field.onChange} />
                            )}
                        />
                        <Controller
                            name="closing-hours"
                            control={control}
                            render={({ field }) => (
                                <DropDownComponent label="Closing Hours" name="closing-hours" options={timeOptions} value={field.value} onChange={field.onChange} />
                            )}
                        />
                    </div>
                    ...
                    <div className='flex flex-col gap-3 md:flex-row'>
                        <Controller
                            ...
                            control={control}
                            render={({ field }) => (
                                <DropDownComponent label="Select Facilities" name="facilities" options={facilitiesOptions} value={field.value} onChange={field.onChange} />
                            )}
                        />
                        <Controller
                            ...
                            control={control}
                            render={({ field }) => (
                                <DropDownComponent label="Select Payment Methods" name="payment-methods" options={paymentOptions} value={field.value} onChange={field.onChange} />
                            )}
                        />
                    </div>
