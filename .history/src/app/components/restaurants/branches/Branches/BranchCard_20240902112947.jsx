      ...
      <div className="flex flex-col p-4 w-full">
        <div className="flex justify-between gap-3 flex-col md:flex-row">
          ...
          <div className="flex gap-2 ">
            <button className=" text-blue-500 h-[40px] p-2 px-4 flex gap-2 flex-center text-base rounded-lg border border-blue-500">
              <Image src={images.modify}  alt="" /> Modify
            </button>
            <button className=" text-red-500 p-2 h-[40px] flex gap-2 flex-center text-base rounded-lg border border-red-500">
