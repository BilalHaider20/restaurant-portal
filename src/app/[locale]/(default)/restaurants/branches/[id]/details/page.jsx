...
import MenuItem from '@/app/[locale]/(default)/restaurant/components/MenuItem' 
import Switch from '@/app/[locale]/(default)/restaurant/components/Switch'
  ...
  const renderTab = () => {
    switch (activeTab) {
      case 'Floors':
        return (
          <>
            <TabLayout title={"Floor Details"} btntext={"add_new_branch"} inputPlaceholder={"branches"}  onClick={handleOpenModal} />
