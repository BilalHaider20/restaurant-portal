    ...
    <div className="relative  flex flex-col sm:flex-row border border-gray-200 rounded-lg shadow-md overflow-hidden">
      {/* <div className=""> */}
        <Image
          ...
          alt=""
          layout="responsive"
          className="object-cover max-w-[340px] "
      ...
      <div className="flex flex-col p-4 w-full">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2 ">
            <button className=" text-blue-500 p-2 flex gap-2 flex-center text-base rounded-lg border border-blue-500">
          ...
          <div className="flex flex-col gap-2 justify-between mt-2 items-start">
