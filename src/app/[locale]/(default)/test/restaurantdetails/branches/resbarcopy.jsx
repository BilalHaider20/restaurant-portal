...
// import DeleteConfirmationBox from './components/DeleteConfirmationBox'; // Corrected import
...
//                 <Image src={images.modify} alt='modify' className="mr-[12px]" /> Modify
//               </button>
//               <button
...
//                 onClick={onDelete}
//               >
//                 <Image src={images.trashbin} alt='bin' className="mr-[12px]" /> Delete
//               </button>
//             </div>
//           </div>
//           <div className="w-[150px] h-[28px] gap-[8px] flex items-center justify-center">
//             <button className="w-[71px] h-[32px] flex items-center justify-center rounded border bg-[#EFF4FA]">
//               <p className="w-[47px] gap-[8px] text-[#346CC4] font-medium text-nowrap text-xs leading-4">
//                 Free Wifi
//               </p>
//             </button>
//             <button className="w-[71px] h-[32px] flex items-center justify-center rounded border bg-[#EFF4FA]">
...
//           onDelete={() => openDialog(index)} // Open the dialog on delete
//         />
//       ))}
//       <DeleteConfirmationBox
//         isOpen={isOpen}
//         onClose={closeDialog}
//         onDelete={() => handleDelete(currentIndex)} // Pass the current index for deletion
