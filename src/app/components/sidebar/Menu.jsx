...
const Menu = ({ sidebarOpen }) => {
  ...
  const data = [
    { text: t('dashboard'), icon: images.dashboard, href: '/en/dashboard' },
    { text: t('restaurant'), icon: images.restaurant, href: '/en/restaurants' },
    ...
    { text: t('users'), icon: images.users, href: '/en/dashboard' },
