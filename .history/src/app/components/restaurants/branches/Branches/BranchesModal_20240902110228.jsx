...
import FileUpload from '@/app/components/common/FormElements/FileUpload'
import ImageUpload from 'src/app/components/common/FormElements/ImageUpload.jsx'
                ...
                <div className='m-5 bg-bg-light p-3 space-y-5'>
                    ...
                    <div className='flex flex-col gap-3 md:flex-row'>
                        <Controller
                            ...
                            control={control}
                            render={({ field }) => (
                                <DropDownComponent label={t('branchCity')} name="city" options={cityOptions} value={field.value} onChange={field.onChange} />
                            )}
                        />
                        <Controller
                            name="country"
                            control={control}
                            render={({ field }) => (
                                <DropDownComponent label={t('branchCountry')}  name="country" options={countryOptions} value={field.value} onChange={field.onChange} />
                            )}
                        />
                    </div>
                    <div className='flex flex-col gap-3 md:flex-row'>
                        <Controller
                            ...
                            control={control}
                            render={({ field }) => (
                                <DropDownComponent label={t("chooseDay")} name="day" options={dayOptions} value={field.value} onChange={field.onChange} />
                            )}
                        />
                        ...
                        <Controller
                            ...
                            control={control}
                            render={({ field }) => (
                                <DropDownComponent label={t('openingHours')} name="opening-hours" options={timeOptions} value={field.value} onChange={field.onChange} />
                            )}
                        />
                        <Controller
                            name="closing-hours"
                            control={control}
                            render={({ field }) => (
                                <DropDownComponent label={t('closingHours')} name="closing-hours" options={timeOptions} value={field.value} onChange={field.onChange} />
                            )}
                        />
                    </div>
                    ...
                    <div className='flex flex-col gap-3 md:flex-row'>
                        <Controller
                            ...
                            control={control}
                            render={({ field }) => (
                                <DropDownComponent label={t("DropDownComponentFacilities")} name="facilities" options={facilitiesOptions} value={field.value} onChange={field.onChange} />
                            )}
                        />
                        <Controller
                            ...
                            control={control}
                            render={({ field }) => (
                                <DropDownComponent label={t("DropDownComponentPayment")} name="payment-methods" options={paymentOptions} value={field.value} onChange={field.onChange} />
                            )}
                        />
                    </div>
